...
class UserInfo(models.Model):
    ...
    avg_time_pages = models.FloatField(
        "Average Time spent on Pages", blank=True, null=True
    )
    avg_time_pages_a = models.FloatField(
        "Average Time spent on Pages A", blank=True, null=True
    )
    cluster_1 = models.CharField(
        "Cluster 1", max_length=1, blank=True, null=True
    )
    cluster_2 = models.CharField(
        "Cluster 2",
        choices=CLUSTER_2_CHOICES,
        max_length=1,
        blank=True,
        null=True,
    )
...
class UserInfo2(models.Model):
    ...
    avg_time_pages_b = models.FloatField(
        "Average Time spent on Pages B", blank=True, null=True
    )
    cluster_2 = models.CharField(
        "Cluster 2", max_length=1, blank=True, null=True
    )
