    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loss', models.CharField(blank=True, choices=[('least_squares', 'Least Squares'), ('least_absolute_deviation', 'Least Absolute Deviation'), ('poisson', 'Poisson')], default='least_squares', help_text='The loss function to be used in the boosting process. If none is given, least_squares will be used.', max_length=50, null=True, verbose_name='Loss function')),
