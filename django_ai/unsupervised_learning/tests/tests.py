...
from django_ai.unsupervised_learning.models import UnsupervisedLearningTechnique
...
class TestUnsupervisedLearning(SimpleTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.ult, _ = UnsupervisedLearningTechnique.objects\
            .get_or_create(
    ...
    def test_ult_validation(self):
        ...
        with self.assertRaises(ValidationError):
            self.ult.results_storage = \
                "dmf:ult_test_models.UserInfo.n-e-field"
            self.ult.full_clean()
